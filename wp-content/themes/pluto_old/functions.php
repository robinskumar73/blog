...
if (!defined('PLUTO_THEME_VERSION')) define('PLUTO_THEME_VERSION', '1.8.3');
...
function osetin_menu_body_class($classes) {
  ...
  if(is_home() || is_page_template('page-photos.php') || is_page_template('page-masonry.php') || is_page_template('page-masonry-condensed.php') || is_page_template('page-masonry-condensed-facebook.php')){
  ...
  if(is_archive() || is_home() || get_field('page_fixed_width') == true || is_page_template('page-masonry.php') || is_page_template('page-masonry-condensed.php') || is_search() || is_page_template('page-photos.php')){
